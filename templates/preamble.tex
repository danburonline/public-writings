...
% Check if templatevariant is defined
% Default to essay if not
...
\usepackage[font=footnotesize,skip=7pt,labelfont=bf]{caption}  % Floating envs
\usepackage[breaklinks,linktocpage]{hyperref}  % Hyperlinks
...
% \backgroundsetup{contents=DRAFT, opacity=0.25, color=gray} % Adds a watermark
% This command changes the line spacing to double for reviews/comments
