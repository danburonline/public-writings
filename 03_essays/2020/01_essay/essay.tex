...
\usepackage{tabularx}  % Allows for tables that span the width of the page
...
\begin{sloppypar}  % The sloppypar environment adjusts the spaces between words such that each line fits into the text width
  ...
  \begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{@{}lX@{}}
      ...
      \addlinespace
      eBay             & Barcode Scanner. eBay improved their JavaScript barcode scanner by rebuilding it in C++, compiling it to WebAssembly to enhance its success rate significantly.              \\
      \bottomrule
    \end{tabularx}
