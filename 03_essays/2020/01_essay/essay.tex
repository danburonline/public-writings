...
\documentclass[10pt]{article}  % Sets the document class and font size
...
% ! Start of the document content and settings
\begin{document}
\pagenumbering{roman}
...
\begin{sloppypar}
  ...
  \pagenumbering{Roman}  % Changing the page numbering to uppercase Roman numerals
  ...
  % This command adds the list of listings to the table of contents
  \addcontentsline{toc}{section}{\lstlistlistingname}
  % This command prints the list of code listings
  \lstlistoflistings

  \pagebreak

  \pagenumbering{arabic}  % Changing the page numbering back to Arabic numerals
  ...
  % TODO Increase distance between last row and bottom line

  \begin{table}[ht]
    \centering
    \renewcommand{\arraystretch}{1.5} % Increasing space between rows
    \renewcommand{\tabcolsep}{7pt} % Increasing space between columns
    \begin{tabularx}{\textwidth}{{@{}lX@{}}}
      ...
      \arrayrulecolor{lightgray} % Start coloring the lines light gray
      \midrule
      ...
      \arrayrulecolor{black} % Revert the rule color back to black
      \addlinespace
      \Xhline{2.75\arrayrulewidth} % Makes the top line thicker
    \end{tabularx}
