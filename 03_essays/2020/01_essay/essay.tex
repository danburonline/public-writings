...
\usepackage{tabularx, booktabs, array} % For advanced table layout
...
\begin{sloppypar}  % The sloppypar environment adjusts the spaces between words such that each line fits into the text width
  ...
  \begin{table}[ht]
    \centering
    % Set the amount of padding within each cell
    \setlength{\extrarowheight}{4pt}
    \begin{tabularx}{\textwidth}{|@{\hspace{2mm}}l|@{\hspace{2mm}}X@{\hspace{2mm}}|}
      \hline
