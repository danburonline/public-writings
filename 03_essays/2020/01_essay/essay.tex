...
% ! Start of the document meta information and settings
\begin{document}
% Changing the initial page numbering to uppercase Roman numerals
\pagenumbering{roman}
...
\begin{sloppypar}
  ...
  % Changing the page numbering back to uppercase Roman numerals
  \pagenumbering{Roman}
  ...
  % Changing the page numbering back to Arabic numerals
