...
\begin{sloppypar}  % The sloppypar environment adjusts the spaces between words such that each line fits into the text width
  ...
  % simple 2 wide and 3 height table
  \begin{table}[ht]
    \centering
    \begin{tabular}{|c|c|c|}
      \hline
      \textbf{Company}                              & \textbf{Use Case}     & \textbf{Link}                                                                                               \\
      \hline
      \hline
      \href{https://www.autodesk.com/}{Autodesk}    & 3D CAD Software       & \href{https://www.autodesk.com/products/fusion-360/blog/fusion-360-now-runs-entirely-in-the-browser/}{Link} \\
      \hline
      \href{https://www.epicgames.com/}{Epic Games} & Unreal Engine 4       & \href{https://www.unrealengine.com/en-US/blog/epic-games-unreal-engine-4-1-release}{Link}                   \\
      \hline
      \href{https://www.adobe.com/}{Adobe}          & Photoshop             & \href{https://www.adobe.com/products/photoshop.html}{Link}                                                  \\
      \hline
      \href{https://www.blender.org/}{Blender}      & 3D Modelling Software & \href{https://www.blender.org/2-8/}{Link}                                                                   \\
      \hline
      \href{https://www.unity.com/}{Unity}          & Game Engine           & \href{https://blogs.unity3d.com/2018/08/15/webassembly-is-here/}{Link}                                      \\
      \hline
    \end{tabular}
    \caption{Real-world use cases for WebAssembly}
  \end{table}
  \label{tab:use-cases}
