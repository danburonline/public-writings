...
\usepackage[nottoc]{tocbibind}  % Adds entries for lof, lot, etc. to the table of contents
\usepackage[font=small,skip=7pt,labelfont=bf]{caption}  % Customizing captions in floating envs
