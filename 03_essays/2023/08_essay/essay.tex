...
\begin{sloppypar} % For better line breaks
  ...
  \section{Thinking Outside the Box}
  \label{sec:outside-the-box}

  % Write something about how the research into the field of lab-grown meat can also foster funding, awareness and transfer of knowledge to the field of tissue engineering and regenerative medicine, such as the development of organoids and organ-on-a-chip technologies.
