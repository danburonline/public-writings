...
\begin{sloppypar} % For better line breaks
  ...
  Messaging should focus on safety, nutritional parity with conventional meat, and ecological benefits, as these factors are likely top concerns and motivations \citep{circus_exploring_2018}. The higher production costs can also be framed as premium “clean meat”. Generally, a transparent and educational approach is essential to build trust and understanding. E.g. transparent packaging and labelling can communicate the production process and benefits, as exemplary shown in \autoref{fig:cultured-beef}.

  % TODO Improve the in-text citation and mentioning of the figure

  \begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{figures/cultured-beef.png}
    \caption[Packaged Cultured Beef Product]{\textbf{The Future of Meat on Shelves: Packaged Cultured Beef.} The image displays lab-grown meat products in retail packaging, symbolizing the market-ready stage of cultured beef. This visual representation aligns with marketing strategies for initial consumer adoption, emphasizing the product's high-tech and sustainability attributes.}
    \label{fig:cultured-beef}
  \end{figure}

  % TODO Cite Dalle3 and ChatGPT here
