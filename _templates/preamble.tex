...
% This command must be defined *after* \documentclass but *before* inputting this preamble.
...
% \overfullrule=5pt % This command is used to show the overfull lines in the document.
