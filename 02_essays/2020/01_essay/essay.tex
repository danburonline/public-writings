...
\newcommand{\customcaption}[2]{\caption[#1.]{#1~\citep{#2}.}}
...
\begin{sloppypar}  % The sloppypar environment adjusts the spaces between words such that each line fits into the text width
  ...
  A quote by Jeff Atwood (co-founder of Stack Exchange) that is popularly referred to as Atwood’s Law. Ever since frameworks like NodeJS or React Native became widely used, JavaScript’s possibilities already crossed the border of just living on the client-side inside of a browser. It’s nearly everywhere.
  ...
  \begin{figure}[ht]
    ...
    \caption{Google Trends curve about NodeJS and React Native \citep{google_google_nodate}}
