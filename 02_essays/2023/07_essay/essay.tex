...
\begin{sloppypar} % For better line breaks
  \begin{abstract}
    This essay synthesises the current understanding of the basal ganglia pathways. It focuses on the direct and indirect neural circuits and their roles in motor control, decision-making, reward processing, and motor learning. The traditional dichotomous model is critically discussed, and recent evidence suggesting a nuanced, dynamic interaction between the two pathways is examined. The author utilises key studies employing optogenetic techniques, contributing to a deeper understanding of these pathways’ concurrent activation and divergence during action initiation and execution. The implications of alterations in these pathways in diagnosing Parkinson’s disease symptoms are also explored.

    Furthermore, the essay outlines potential therapeutic strategies for mitigating the motor symptoms of Parkinson’s disease and proposes avenues for future research. Despite the significant strides made in understanding the basal ganglia circuit dynamics, the author highlights the need for further research to unravel the intricate mechanisms coordinating the interactions between the pathways during action selection and learning.
  \end{abstract}
  \pagebreak
