...
\begin{sloppypar} % For better line breaks
  ...
  Interestingly, they observed a decrease in the activity of iMSNs during movement, a change not seen in dMSNs. This finding indicates that while both pathways are involved in action initiation, their roles may diverge during action execution. This concurrent activation and divergence challenge the traditional view of the direct and indirect pathways acting as separate and opposing ‘levers’ for movement facilitation and suppression. Instead, \citeauthor{cui_concurrent_2013} ’s findings suggest a more nuanced understanding of where these pathways dynamically interact and compete during action decisions.
  ...
  More recently, researchers have continued to harness the power of optogenetics to further our understanding of the basal ganglia’s direct and indirect pathways. \cite{yttri_opponent_2016} used cell-type-specific optogenetic stimulation to investigate the bidirectional control of movement velocity, while \cite{guillaumin_optogenetic_2020} explored the roles of these pathways in reward-based learning. \cite{hilt_evidence_2016} examined their roles in motor learning.
  ...
  Despite these advances, the mechanisms underlying the dynamic interaction between the direct and indirect pathways are yet to be fully elucidated. As the refinement and application of optogenetic techniques continue, future research is promising to shed further light on these intricate neural circuits. Such advancements will enhance our understanding of basal ganglia function and motor control and have profound implications for understanding movement disorders like Parkinson’s disease and developing potential therapeutic strategies.
