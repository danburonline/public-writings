...
\begin{sloppypar} % For better line breaks
  ...
  Studies employing optogenetic techniques, such as \cite{cui_concurrent_2013}, \cite{kravitz_regulation_2010}, \cite{yttri_opponent_2016}, \cite{guillaumin_optogenetic_2020}, \cite{hilt_evidence_2016}, and \cite{wang_direct_2015}, have provided critical insights. Collectively, they suggest that the direct and indirect pathways work in tandem during movement initiation but may have distinct, and sometimes opposing, roles during other processes like reward-based learning and velocity control.
