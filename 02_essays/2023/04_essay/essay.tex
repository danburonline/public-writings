  ...
  \begin{table}[ht]
    ...
    \resizebox{\linewidth}{!}{%
      \begin{tabular}{|>{\hspace{0pt}}m{0.34\linewidth}|>{\hspace{0pt}}m{0.6\linewidth}|}
        ...
        \hline
        “Deep Brain Stimulation of the Rat Subthalamic Nucleus Induced Inhibition of Median Raphe Serotonergic and Dopaminergic Neurotransmission” & The study found that subthalamic stimulation improved motor function and reduced depressive symptomatology in rats with advanced Parkinson's disease. The stimulation was performed in a safe and controlled environment using mice, allowing researchers to observe the effects of stimulation on the brain without the risk of harm to humans. \\
        \hline
