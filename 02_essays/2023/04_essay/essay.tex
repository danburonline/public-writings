  ...
  \begin{table}[ht]
    ...
    \resizebox{\linewidth}{!}{%
      \begin{tabular}{|>{\hspace{0pt}}m{0.34\linewidth}|>{\hspace{0pt}}m{0.6\linewidth}|}
        ...
        \hline
        "Deep Brain Stimulation for Parkinson’s Disease with Early Motor Complications: A UK Cost-Effectiveness Analysis"         & The incremental cost-effectiveness ratio of DBS compared to BMT is acceptable based on current thresholds.                                                                                                                          \\
        \hline
        "Huntington's disease protein contributes to RNA-mediated gene silencing through association with Argonaute and P bodies" & The Ago family of proteins are essential for small RNA-mediated gene silencing pathways, and the study identified a novel gene containing a trinucleotide repeat that is expanded and unstable on Huntington's disease chromosomes. \\
        \hline
      \end{tabular}
    }
    \caption{Overview of two papers in which the use of animal models were beneficial.}
