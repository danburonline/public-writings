  ...
  \begin{table}[ht]
    ...
    \resizebox{\columnwidth}{!}{%
      \begin{tabular}{|>{\hspace{0pt}}m{0.3\linewidth}|>{\hspace{0pt}}m{0.35\linewidth}|>{\hspace{0pt}}m{0.35\linewidth}|}
        ...
        {\color[HTML]{374151} \textbf{}}                       & {\color[HTML]{374151} \textbf{WHOQOL-BREF}}                                                     & {\color[HTML]{374151} \textbf{Q-LES-Q}}                                                                                                              \\ \hline
        \rowcolor[HTML]{FFFFFF}
        {\color[HTML]{374151} Primary Domain Focus}            & {\color[HTML]{374151} Physical health, Psychological health, Social relationships, Environment} & {\color[HTML]{374151} Physical health, Mood level, Work functioning, Household duties, Leisure activities, Social relationships, General activities} \\ \hline
        \rowcolor[HTML]{FFFFFF}
        {\color[HTML]{374151} Number of Items}                 & {\color[HTML]{374151} 26 items}                                                                 & {\color[HTML]{374151} 93 items}                                                                                                                      \\ \hline
        \rowcolor[HTML]{FFFFFF}
        {\color[HTML]{374151} Scaling}                         & {\color[HTML]{374151} 5-point Likert scale}                                                     & {\color[HTML]{374151} 5-point Likert scale}                                                                                                          \\ \hline
        \rowcolor[HTML]{FFFFFF}
        {\color[HTML]{374151} Sensitivity to Change}           & {\color[HTML]{374151} High/Low (depends on research)}                                           & {\color[HTML]{374151} High/Low (depends on research)}                                                                                                \\ \hline
        \rowcolor[HTML]{FFFFFF}
        {\color[HTML]{374151} Cross-Cultural Adaptability}     & {\color[HTML]{374151} High (developed by WHO, used globally)}                                   & {\color[HTML]{374151} Varies (can be adapted, but not as universal as WHOQOL-BREF)}                                                                  \\ \hline
        \rowcolor[HTML]{FFFFFF}
