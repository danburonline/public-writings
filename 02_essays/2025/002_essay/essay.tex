...
\begin{sloppypar}
  ...
  \begin{itemize}
    ...
    \item \textbf{Phenomenological Grounding}: First-person subjective reporting during interventions supersedes third-party behavioural metrics as the validation standard, ensuring continuity is experientially verifiable.
          % TODO Add no speculative technologies
          % \item \textbf{Urgent Engineering Pragmatism}: Synconetics pursues presently actionable methods, aiming for human application within the next two decades.
  \end{itemize}
