...
\begin{sloppypar}
  ...
  \begin{itemize}
    ...
    \item \textbf{Substrate Conservation}: Biological substrates (e.g., CNS) are consciousness’s sole empirically validated vessels. Augmentations must integrate non-destructively, preserving native dynamics.
