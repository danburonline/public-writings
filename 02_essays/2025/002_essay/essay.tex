...
\begin{sloppypar}
  ...
  We frame death not as an inevitability but as a contingent failure of the organised physical system that instantiates consciousness (i.e., the conscious substrate). Physical processes are, in principle, manipulable: no fundamental law prohibits the indefinite persistence of self-maintaining systems under engineered conditions. We, therefore, define dying operationally as the irreversible destruction of the dynamic processes sustaining conscious continuity through time (i.e., the process-world-line, as shown in \autoref{fig:process-world-line}). By focusing on empirically accessible systems (e.g., the human central nervous system), synconetics circumvents debates about consciousness’s “true nature”—its persistence with what we have at hand becomes an engineering challenge.
