...
\begin{sloppypar}
  ...
  \begin{figure}[ht!]
    ...
    \caption{\% TODO: Complementary Synconetic Strategies. ECP (top path) focuses on incremental biohybrid replacement, leveraging biological mechanisms. CHI (bottom path) pursues direct synthetic integration using hemispheric redundancy. Both aim to achieve a resilient Synthetic Consciousness Substrate (SCS), with potential for shared technological advancements.}
