...
\begin{sloppypar}
  ...
  \begin{figure}[ht!]
    ...
    \caption[The eight steps of Continuity via Biological/Artificial Hemispheric Integration (CHI).]{\textbf{The eight steps of Continuity via Biological/Artificial Hemispheric Integration (CHI).} Adapted from “Ishiki-wa-Dokokara-Yatte-Kurunoka (The Origin of Consciousness)” (Hayakawa-shobo, Illustrator Wataru Yagi).}
