...
\begin{sloppypar}
  ...
  % TODO Improve this without repeating or already spoiling things from further down.

  Synconetics is a new scientific discipline focused on understanding the fundamental aspects of death. It aims to overcome death by developing synthetic consciousness mechanics—engineering interventions designed to maintain the physical-dynamical processes of consciousness using alternative and more resilient substrates. By fundamentally focusing on empirically testable and falsifiable systems that are readily available, such as the human central nervous system (CNS), synconetics avoids philosophical debates about the "true nature" of consciousness and reframes the challenge of preserving consciousness as a practical engineering problem, shaping the discipline’s core axioms.

  \subsection{First Principles of Death}
  \label{sec:first-principles}

  Death is not an inevitability but a contingent failure of the organised physical system that instantiates consciousness (i.e., the conscious substrate). Physical processes are, in principle, manipulable: no fundamental law prohibits the indefinite persistence of self-maintaining systems under engineered conditions. We, therefore, define dying operationally as the irreversible destruction of the processes sustaining conscious space-time continuity.
  ...
  % TODO Have a table where we differentiate between the principles and the conventional paradigms and terminology.
  ...
  % - decoupling agency from embodiment
  % - scale separation of sensory input
  % - direct augmentation in case of computation
  % - co-location for fault-tolerance
