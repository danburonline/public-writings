...
\begin{sloppypar}
  ...
  % \begin{abstract}
  % TODO: Write abstract (Gabriel will write a draft)
  % \end{abstract}
  ...
  \begin{figure}[ht!]
    ...
    \caption{TODO: The 4D process-world-line of a conscious substrate, what it means is that it decays (= death, irreversible loss of conscious continuity) and what it means when we preserve it over another substrate.}
  ...
  \begin{figure}[ht!]
    ...
    \caption{TODO: Showing a graph similar to the one from the old draft in 4D, but with the disembodiment of the conscious substrate on the y-axis and the time on the x-axis. Setting this as a starting point for the upcoming figures.}
  ...
  \begin{itemize}
    ...
    \item \textbf{Phenomenological Grounding}: First-person subjective reporting during interventions supersedes third-party behavioural metrics as the validation standard, ensuring continuity is experientially verifiable.
          % TODO Add no speculative technologies ? add as additional point?
  \end{itemize}
