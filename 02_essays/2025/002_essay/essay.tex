...
\begin{figure}[ht]
  ...
  % \caption{Substack figure caption: Artistic visualisation of consciousness’ physical-dynamical processes.}
  \label{fig:cover}
\end{figure}
...
\newpage
\begin{abstract}
  Death, defined as the irreversible cessation of the physical dynamics underpinning consciousness, is a tractable systems engineering problem. Current approaches, including longevity research and mind uploading, fail to adequately address the continuity of consciousness, relying on destructive replication or unverified substrate-independence. This paper introduces synconetics, a proposed engineering framework to ensure conscious continuity via non-destructive methods. Grounded in empirical validation on near-term technologies, synconetics prioritises the preservation of the four-dimensional process-world-line of an individual’s consciousness. We present two distinct, testable methodologies to achieve this: 1) Ectopic Cognitive Preservation, a gradual, piecemeal replacement of neural tissue with integrated biohybrid grafts, and 2) Continuity via Hemispheric Integration, a transition to a synthetic substrate that leverages the neurobiology of split-brain phenomena. These engineering pathways provide a rigorous alternative to existing paradigms and lay the foundation for treating mortality as a solvable substrate-failure problem.
...
\begin{table}[ht!]
  ...
  \begin{tabular}{p{0.3\textwidth}p{0.6\textwidth}}
    ...
    \midrule
    \makecell[lt]{Process-World-Line                                                                                                                                                                                                           \\ Fidelity} & Prioritises the preservation of the unbroken four-dimensional causal chain of the physical dynamics underlying consciousness. \\
    \midrule
    \makecell[lt]{Non-Destructive                                                                                                                                                                                                              \\ Transition} & Employs gradual replacement or repair validated by first-person reportability, explicitly rejecting destructive scanning or copying methods. \\
    \midrule
    \makecell[lt]{Substrate Agnosticism                                                                                                                                                                                                        \\ with Physical Grounding} & Focuses on necessary physical dynamics rather than material composition (biological vs. synthetic), while requiring substrates to operate as thermodynamically open systems capable of sustaining consciousness-critical dynamics. \\
    \midrule
    ...
    \midrule
    \makecell[lt]{Near-Term Engineering                                                                                                                                                                                                        \\ Urgency} & Leverages existing technologies and incremental advancements rather than awaiting speculative breakthroughs. Focuses on iterative progress using 2020s-era tools while planning for future scalability. \\
    \bottomrule
  \end{tabular}
  \caption{\textbf{Core principles of synconetics.} The five foundational principles that define the synconetics discipline, establishing its methodological framework and operational constraints for addressing consciousness continuity challenges.}
...
\begin{figure}[ht!]
  ...
  \caption[CHI: The eight steps of Continuity via CHI]{\textbf{The eight steps of Continuity via Biological/Artificial Hemispheric Integration (CHI).} Adapted from “Ishiki-wa-Dokokara-Yatte-Kurunoka (The Origin of Consciousness)” (Hayakawa-shobo, Illustrator Wataru Yagi).}
...
Therefore, we issue a direct call to action. For researchers seeking to advance the fundamental science and engineering, opportunities exist for postgraduate work exploring consciousness mechanisms and BMI integration (e.g., with Professor Watanabe’s group at the University of Tokyo) or for developing other unexplored continuity-preserving strategies. For engineers and scientists focused on tangible applications, organisations like Eightsix Science are actively seeking technical collaborators, funding, and grant support to translate synconetics principles into practice via approaches like ECP.

\begin{quote}
  \textbf{Join ongoing Discord discussions to refine this framework and contribute directly to Version 2.0.} Your critiques will inform expanded technical roadmaps while helping build our collaborative research community. Invite link: \url{https://discord.gg/HMZFV2TsAt}
\end{quote}
...
\nocite{*} % This command is used to include all references in the bibliography.
